...
public class Operator extends AbstractUser {
    ...
    public void fileUpload(){
        ...
        String filepath = DataProcessing.in.nextLine();
        String id = Doc.inputId();
        String description = Doc.inputDescription();
        ...
        } else if ( !copyFile(filepath , uploadPath + "%s-%s".formatted(id,filename ) ) ) {
            System.out.println("文件不存在或上传失败");
