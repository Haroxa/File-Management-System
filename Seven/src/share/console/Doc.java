...
public class Doc implements Serializable {
    ...
    public Doc(String sid, String creator, Timestamp timestamp, String description, String filename){
        this.id = sid; this.creator = creator;
        this.timestamp = timestamp; this.description=description;
        this.filename = filename;
    }
    Doc(ResultSet resultSet) throws SQLException {
