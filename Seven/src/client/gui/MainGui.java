    ...
    public static MyFrame newMainGui() {
        ...
        jFrame.addWindowListener(new WindowAdapter() {
            ...
            public void windowActivated(WindowEvent e) {
                System.out.printf("{ gui-msg:userGui/newMainGui/activated, nowUser:%s }\n", jFrame.user);
                ...
                // 设置非管理员不可管理用户信息
                userManageButton.setEnabled(jFrame.user.getRole().equals(DealClient.Role.ADMINISTRATOR.getName()));
            }

            @Override
            public void windowClosed(WindowEvent e) {
                System.out.printf("{ gui-msg:userGui/newMainGui/closing, nowUser:%s }\n", jFrame.user);
                // 关闭窗口时，检查子窗口是否已关闭
