...
public class MyFrame extends JFrame {
    ...
    public void setCurrentGui(MyFrame gui){
        ...
        // 检查是否最小化，恢复至正常大小
        if (checkMinimized( (MyFrame) currentGui)) {
     ...
     * @throws
     */
    public boolean checkMinimized(MyFrame gui) {
     ...
     * @throws
     */
    public boolean checkUserValid(AbstractUser user){
        if (user == null || DataProcessing.searchUser(user.getName()) == null) {
            dispose();
            return false;
        }
        return true;
