...
public class UserGui {
    ...
    public static MyFrame newUserManageGui() {
        ...
        MyFrame insertUserGui = newInsertUserGui(tableModel);
        MyFrame updateUserGui = newUpdateUserGui(jTable);
        MyFrame deleteUserGui = newDeleteUserGui(jTable,tableModel);
     ...
     * @throws
     */
    public static MyFrame newInsertUserGui(DefaultTableModel tableModel) {
     ...
     * @throws
     */
    public static MyFrame newDeleteUserGui(JTable jTable,DefaultTableModel tableModel) {
